    ...
    return new Promise(async (resolve, reject) => {
        try {
            const mailOptions = {
                from: mail.MAIL, // sender address
                to: user.email, // list of receivers
                subject: "Bharat Exam Fest - Email Verification",
                html: `<html lang="en-US">
    
                <head>
                    <meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
                    <title>Bharat Exam Fest - Email Verification</title>
                    <meta name="description" content="Email Verification for Bharat Exam Fest.">
                    <style type="text/css">
                        a:hover {
                            text-decoration: underline !important;
                        }
                                                ...
                                                <tr>
                                                    <td style="padding:0 35px;">
                                                        ...
                                                        <span
                                                            style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                            Hi ${(user.name != null ? user.name : 'dear')} ${(user.firstName != null ? user.firstName : 'dear')} ${(user.lastName != null ? user.lastName : '')}, 
                                                            <br>
                                                            Welcome to the Bharat Exam Fest! Please verify your email to continue.
                                                            <br>
                                                            OTP will expire in 10 minutes.
                                                            <br>
                                                            Verification code: ${otp}
